        ...
        public KetQuaXuLy LapDat(string soPhieu, string maTN, string soPhong, DateTime ngay, string tinhTrang, string maNV, string ghiChu)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO PhieuLapDat VALUES(@p,@tn,@ph,@n,@tt,@nv,@g)",
                    new SqlParameter("@p", soPhieu), new SqlParameter("@tn", maTN), new SqlParameter("@ph", soPhong), new SqlParameter("@n", ngay.Date), new SqlParameter("@tt", tinhTrang), new SqlParameter("@nv", maNV), new SqlParameter("@g", ghiChu));
